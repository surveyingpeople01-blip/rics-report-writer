...
// Section E Data interface
interface SectionEData {
    limitationsText: string;
    e1RoofStructure: SubsectionData;
    e2Ceilings: SubsectionData;
    e3WallsPartitions: SubsectionData;
    e4Floors: SubsectionData;
    e5Fireplaces: SubsectionData;
    e6BuiltInFittings: SubsectionData;
    e7Woodwork: SubsectionData;
    e8BathroomFittings: SubsectionData;
    e9Other: SubsectionData;
}

interface SectionEProps {
    data: SectionEData;
    onDataChange: (data: Partial<SectionEData>) => void;
...
// Default Section E data
const defaultSectionEData: SectionEData = {
    limitationsText: `The inspection of the inside of the property was visual and non-invasive. We did not move heavy furniture, lift floor coverings or look under sub-floors unless explicitly stated. The inspection of the roof structure was carried out from the access hatch. 

We did not test any electrical or gas appliances, or the heating system.`,
    e1RoofStructure: { ...defaultSubsection },
    e2Ceilings: { ...defaultSubsection },
    e3WallsPartitions: { ...defaultSubsection },
    e4Floors: { ...defaultSubsection },
    e5Fireplaces: { ...defaultSubsection },
    e6BuiltInFittings: { ...defaultSubsection },
    e7Woodwork: { ...defaultSubsection },
    e8BathroomFittings: { ...defaultSubsection },
    e9Other: { ...defaultSubsection }
};

export function SectionE({ data, onDataChange, autoResponses, onAddPhoto }: SectionEProps) {
    const subsections = [
        { key: 'e1RoofStructure', id: 'e1', title: 'E1 Roof structure' },
        { key: 'e2Ceilings', id: 'e2', title: 'E2 Ceilings' },
        { key: 'e3WallsPartitions', id: 'e3', title: 'E3 Walls and partitions' },
        { key: 'e4Floors', id: 'e4', title: 'E4 Floors' },
        { key: 'e5Fireplaces', id: 'e5', title: 'E5 Fireplaces, chimney breasts and flues' },
        { key: 'e6BuiltInFittings', id: 'e6', title: 'E6 Built-in fittings (kitchen and other)' },
        { key: 'e7Woodwork', id: 'e7', title: 'E7 Woodwork (e.g. staircase and joinery)' },
        { key: 'e8BathroomFittings', id: 'e8', title: 'E8 Bathroom fittings' },
        { key: 'e9Other', id: 'e9', title: 'E9 Other' },
    ];
                ...
                <div className="space-y-4">
                    {subsections.map(({ key, id, title }) => (
                        <Subsection
                            ...
                            id={id}
                            title={title}
                            data={data[key as keyof SectionEData] as SubsectionData}
...
export { defaultSectionEData };
export type { SectionEData };
