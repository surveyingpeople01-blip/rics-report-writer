import { AlertTriangle, ChevronDown, ChevronUp, Image as ImageIcon, MessageCircle, Plus } from 'lucide-react';
import { useState, useRef } from 'react';

// Subsection data interface for Section I (Risks - mainly text fields)
interface SubsectionData {
    text: string;
}

// Section I Data interface
interface SectionIData {
    i1BuildingRisks: SubsectionData;
    i2GroundsRisks: SubsectionData;
    i3PeopleRisks: SubsectionData;
    i4OtherRisks: SubsectionData;
}

interface SectionIProps {
    data: SectionIData;
    onDataChange: (data: Partial<SectionIData>) => void;
...
// Default Section I data
const defaultSectionIData: SectionIData = {
    i1BuildingRisks: { ...defaultSubsection },
    i2GroundsRisks: { ...defaultSubsection },
    i3PeopleRisks: { ...defaultSubsection },
    i4OtherRisks: { ...defaultSubsection }
};

export function SectionI({ data, onDataChange, autoResponses, onAddPhoto }: SectionIProps) {
    const subsections = [
        { key: 'i1BuildingRisks', id: 'i1', title: 'I1 Risks to the building' },
        { key: 'i2GroundsRisks', id: 'i2', title: 'I2 Risks to the grounds' },
        { key: 'i3PeopleRisks', id: 'i3', title: 'I3 Risks to people' },
        { key: 'i4OtherRisks', id: 'i4', title: 'I4 Other risks or hazards' },
    ];
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                <div className="flex items-center gap-3 mb-8 pb-4 border-b border-gray-200">
                    <AlertTriangle className="text-survey-blue" size={32} />
                ...
                <p className="text-gray-600 mb-8 italic">
                    This section summarises defects and issues that present a risk to the building or grounds, or a safety risk to people. These may have been reported in other sections of this report in detail. If so, they are listed here but reference the specific section for full details.
                </p>
                ...
                <div className="space-y-4">
                    {subsections.map(({ key, id, title }) => (
                        <Subsection
                            ...
                            id={id}
                            title={title}
                            data={data[key as keyof SectionIData] as SubsectionData}
...
export { defaultSectionIData };
export type { SectionIData };
